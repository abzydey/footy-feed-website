  ...
  return (
    <form onSubmit={handleSubmit} className="mt-3 space-y-3 rounded-lg bg-black/30 border border-white/10 p-3">
      ...
      <button
        ...
        className="w-full bg-brand-violet hover:bg-brand-hover disabled:opacity-60 text-white font-bold px-4 py-2 text-sm transition-all duration-150 active:scale-[0.98]"
      >
