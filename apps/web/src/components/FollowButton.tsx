  ...
  return (
    <div>
      <button
        ...
        className={`rounded-full border-2 border-brand-violet text-brand-violet font-bold hover:bg-brand-hover hover:border-brand-hover hover:text-white disabled:opacity-60 transition-all duration-150 active:scale-95 ${sizeClasses}`}
      >
